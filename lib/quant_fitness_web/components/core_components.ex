defmodule QuantFitnessWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuantFitnessWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuantFitnessWeb.Gettext, "errors", msg, opts)
    end
  end
